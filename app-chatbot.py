...
@st.cache_resource
def load_qa_model():
    """ Load and return a QA transformers pipeline """
    return pipeline(task="question-answering", model="distilbert-base-uncased-distilled-squad", device=-1)
...
qa_pipeline({"question": "What is the portal about ?", "context": context_data}) # Warm-up

def get_answer(question, context):
    """ Return answer from the qa pipeline """
