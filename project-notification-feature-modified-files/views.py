...
from .serializers import ProjectSerializer, FeedbackSerializer, FacilityRequestSerializer, UserSerializer, NotificationSerializer
...
class FacilityRequestViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        """ Filters requests based on the role of the logged in user """
