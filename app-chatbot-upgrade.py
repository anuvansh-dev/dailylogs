...
# Chatbot 
# Loading a text generation model for chatbot
@st.cache_resource
...
def get_answer(question, context):
    """ Return answer from Mistral-7B API """
...
def show_chatbot():
    ...
    user_query = st.text_input("Ask me anything about the portal (e.g., 'What is the status of request 102 ?'): ")   

    if user_query:
        answer = get_answer(question=user_query, context=context_data)
